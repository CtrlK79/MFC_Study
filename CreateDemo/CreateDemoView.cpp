...
int CCreateDemoView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndChild.Create(_T("STATIC"), _T("This is my first MFC program"),
		WS_CHILD | WS_VISIBLE | WS_BORDER,
		CRect(30, 30, 180, 180), this, 1234);

	m_wndChild2.Create(_T("BUTTON"), _T("Exciting!"),
		WS_CHILD | WS_VISIBLE | WS_BORDER | WS_CAPTION | WS_HSCROLL | WS_VSCROLL,
		CRect(400, 400, 580, 580), this, 1234);
